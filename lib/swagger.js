...
(function () {
  ...
  SwaggerResource.prototype.addOperations = function (resource_path, ops, consumes, produces) {
    if (ops) {
      ...
      for (var i = 0; i < ops.length; i++) {
        ...
        var op = new SwaggerOperation(o, resource_path, method, type, responseMessages, this, consumes, produces, tags);
  ...
  var SwaggerOperation = function (o, path, method, type, responseMessages, resource, consumes, produces, tags) {
    var _this = this;
    var nickname = o.nickname;
    var parameters = o.parameters;
    var summary = o.summary;
    var notes = o.notes;
    var authorizations = o.authorizations;
    ...
    if (typeof this.type !== 'undefined' && this.type === 'void')
      ...
      this.responseClassSignature = this.getSignature(this.type, this.resource.models, true, {description: o.description});
  ...
  SwaggerOperation.prototype.getSignature = function (type, models, forSchema, extraInfo) {
    ...
    if (isPrimitive) {
      if(forSchema) {
        var tpl = [
          ...
          '</span>',
          '<span class="propDesc">',
          extraInfo.description ? extraInfo.description : 'Return ' + type + 's',
          '</span></div>'
          ].join('');
